...
public class GestionDeAccionesDeUsuariosTest {
	...
	public void inicializar(){
		...
		filtroPorComuna = new FiltradoPorComuna(5);
		usuarioPepe = new Usuario("Pepe",new Posicion(5.0, 10.0),5);
	...
	public void seEjecutaElProcesoYNoSeEnviaMailAlAdministrador() {
		proceso3.ejecutar();
		buscador.registrarBusqueda(usuarioPepe, null, 0, LocalDateTime.now(), LocalDateTime.now().plus(Duration.ofHours(5)));		
