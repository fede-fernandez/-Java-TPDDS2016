...
public class PlanificadorDeProcesosTest {
	...
	private PlanificadorDeProcesos planificador;
	private ProcesoImpostor procesoImpostor;
	private ProcesoQueFallaImpostor procesoQueFallaImpostor;
	private NoHacerNada noHacerNada;
	private NotificarAlAdministrador notificarAlAdministrador;
	private ReintentarEjecucion reintentarEjecucion;
	private Administrador administrador;
	private EnviadorDeMail enviadorDeMail;
	private MailServiceImpostor servicioDeMailImpostor;
	...
	@Test
	public void falloElProcesoYSeSeNotificaAlAdministrador() throws InterruptedException {
		procesoQueFallaImpostor = new ProcesoQueFallaImpostor();
		notificarAlAdministrador = new NotificarAlAdministrador(procesoQueFallaImpostor, administrador, enviadorDeMail);
		procesoQueFallaImpostor.enCasoDeFalloHacer(notificarAlAdministrador);
